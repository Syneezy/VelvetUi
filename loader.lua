--[[  
    ...
    Option B — GitHub HTTP (any executor with internet access):  
        local VelvetUi = loadstring(game:HttpGet(  
            "https://raw.githubusercontent.com/Syneezy/VelvetUi/main/loader.lua"  
        ))()  
    ...
    Option D — Force a specific strategy (advanced):  
        local VelvetUi = loadstring(readfile("VelvetUi/loader.lua"))({  
            ...
            baseUrl  = "https://raw.githubusercontent.com/Syneezy/VelvetUi/main/",  
        })  
...
return function(config)  
    ...
    local BASE_URL  = config.baseUrl  or "https://raw.githubusercontent.com/Syneezy/VelvetUi/main/"  
